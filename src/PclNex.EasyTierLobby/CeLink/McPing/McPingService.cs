...
public class McPingService : IMcPingService
{
    ...
    public async Task<McPingResult?> PingAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            LogWrapper.Debug(ex, ModuleName, $"Connection to {_endpoint} was cancelled or timed out.");
            return null;
        }
        catch (Exception e)
        {
            LogWrapper.Debug(e, ModuleName, $"Failed to connect to {_endpoint}.");
            return null;
        }
        ...
        {
            LogWrapper.Debug(ex, ModuleName, $"Communication with {_endpoint} was cancelled or timed out.");
            return null;
        }
        catch (Exception e)
        {
            LogWrapper.Debug(e, ModuleName, $"Failed to communicate with {_endpoint}: {e.Message}");
            return null;
        }
        finally
        {
