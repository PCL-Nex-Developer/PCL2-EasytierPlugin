...
public static class LobbyService
{
    ...
    public static async Task InitializeAsync()
    {
        ...
        {
            // refresh naid token
            var naidRefreshToken = EasyTierPluginState.NaidRefreshToken;
            if (!string.IsNullOrWhiteSpace(naidRefreshToken))
            {
                var expTime = EasyTierPluginState.NaidRefreshExpireTime;
    ...
    public static async Task<bool> CreateLobbyAsync(int port, string username)
    {
        ...
        try
        {
            ...
            CurrentLobbyCode = serverEntity.Tunnel.LobbyCode;
    ...
    private static void _CheckGameState(object? state)
    {
        ...
        LobbyController.IsHostInstanceAvailableAsync(_LobbyController.ScfServerEntity.Tunnel.MinecraftPort)
