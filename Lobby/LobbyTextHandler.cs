...
public static class LobbyTextHandler
{
    ...
    public static string GetConnectTypeName(LobbyTunnelConnectionWay type)
    {
        return Lang.Text(type switch
        {
            LobbyTunnelConnectionWay.Local => "Link.Connection.Local",
            LobbyTunnelConnectionWay.P2P => "Link.Connection.P2P",
            LobbyTunnelConnectionWay.Relay => "Link.Connection.Relay",
